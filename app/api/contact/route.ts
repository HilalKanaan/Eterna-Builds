        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="background:#143531;padding:36px 40px;">
              ...
              <p style="margin:6px 0 0;font-size:11px;color:#487d47;letter-spacing:0.25em;text-transform:uppercase;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 16px;font-size:10px;color:#487d47;letter-spacing:0.3em;text-transform:uppercase;font-weight:600;">
                      Enquiry Summary
                    </p>
        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="background:#143531;padding:28px 40px;">
              ...
              <p style="margin:6px 0 0;font-size:11px;color:#487d47;letter-spacing:0.2em;text-transform:uppercase;">
          ...
          <tr>
            <td style="padding:32px 40px 28px;">
              ...
              <!-- Contact details -->
              <table width="100%" cellpadding="0" cellspacing="0"
                style="background:#f7f9f9;border-left:3px solid #487d47;border-radius:2px;margin:0 0 24px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 14px;font-size:10px;color:#487d47;letter-spacing:0.3em;text-transform:uppercase;font-weight:600;">
                      Contact Details
                    </p>
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
